...
import backgroundImage from 'assets/fontChatMessage/fontchat.png';
import {
  ConnectionObjType,
  MessageDataObjType,
  MessageObjType,
...
const MessagesScreen: React.FC<MessagesScreenProps> = ({
  ...
  return (
    <StyledMessageScreen>
      ...
      {/* {userMessages && user ? ( */}
      <StyledMsgScreenScrollbar ref={_scrollBarRef as any} style={{backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center',}}>
  <MessagesList
