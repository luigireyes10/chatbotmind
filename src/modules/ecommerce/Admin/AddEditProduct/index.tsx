...
export const AddEditProduct = ({ selectedProd }: Props) => {
    ...
    if (selectedProd) {
      ...
      putDataApi("/api/ecommerce/list/update", infoViewActionsContext, {
        ...
        .then(() => {
          ...
          infoViewActionsContext.showMessage("Producto actualizado!");
        })
        .catch((error) => {
      ...
      postDataApi("/api/ecommerce/list/add", infoViewActionsContext, {
        ...
        .then(() => {
          infoViewActionsContext.showMessage("Producto creado!");
          router.push("/ecommerce/product-listing");
        })
        .catch((error) => {
          infoViewActionsContext.fetchError(error.message);
  ...
  return (
    <>
      <StyledTitle5>
        {selectedProd ? "Edit Producto" : "Crear un nuevo producto"}
      </StyledTitle5>
